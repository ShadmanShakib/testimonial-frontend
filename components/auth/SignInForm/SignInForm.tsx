  ...
  return (
    <section className="mx-auto max-w-md bg-white py-8 px-4 shadow dark:bg-gray-800 sm:rounded-lg sm:px-10 ">
      ...
      <div className="w-full px-3">
        ...
        <input
          className="mb-2 w-full py-2 px-3 text-gray-600 outline-none dark:text-gray-800"
          type="string"
          {...register("username")}
      ...
      <div>
        <p className="my-2 w-full text-center  text-purple-600 transition duration-150 ease-in-out hover:text-gray-600 dark:hover:text-gray-200">
          Forget password?
        </p>
      </div>
      <div className="w-full px-3">
